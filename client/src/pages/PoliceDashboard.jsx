    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 min-w-0">
        ...
        <main className="p-4 lg:p-6">
          ...
          {activeSection === "policePanel" && (
            <div className="flex flex-col items-center justify-center h-full">
              <h2 className="text-2xl font-bold mb-4">Police Panel</h2>
              <div className="w-full h-96 bg-gray-100 rounded-lg flex items-center justify-center">
                {/* Replace with your actual police panel content */}
                <span className="text-gray-500">Police Panel content goes here.</span>
              </div>
            </div>
          )}
          {/* You can add similar blocks for "cases" and "reports" if you want */}
        </main>
      </div>
    </div>
  );
